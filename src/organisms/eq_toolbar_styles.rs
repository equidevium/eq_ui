...
/// the primary row.
pub const WRAPPER: &str = "w-full bg-[var(--color-card)] \
     border-b border-[var(--color-card-border)]";

/// Primary row. Three-region flex layout: start | title | end.
pub const PRIMARY: &str = "flex items-center gap-2 \
     min-h-[56px] px-3";
...
pub const TITLE: &str = "flex-1 min-w-0 text-base font-semibold \
...
pub const SECONDARY: &str = "px-3 py-2 \

...
pub const HERO_SHELL: &str = "py-12 md:py-28 bg-[var(--gradient-background)]";
...
pub const HERO_ACTIONS: &str = "mt-6 md:mt-8 flex flex-wrap gap-3 md:gap-4";

pub const HERO_SHELL_RELATIVE: &str = "relative overflow-hidden";
pub const HERO_BG: &str = "absolute inset-0 w-full h-full";

pub const HERO_OVERLAY: &str = "absolute inset-0 bg-black/50";
pub const HERO_CONTENT: &str = "relative z-10";

...
/// Caption title
pub const CAPTION_TITLE: &str = "text-lg font-semibold text-[var(--color-label-primary)]";
/// Caption description
pub const CAPTION_DESCRIPTION: &str = "text-sm text-[var(--color-label-secondary)] leading-relaxed";
/// Caption attribution / credit
pub const CAPTION_ATTRIBUTION: &str = "text-xs text-[var(--color-label-secondary)] italic pt-1 border-t border-[var(--color-card-border)]";
...
pub const OVERLAY_TEXT_WRAPPER: &str = "absolute inset-0 flex flex-col justify-end p-4";

...
pub const TRIGGER: &str = "inline-flex items-center justify-between gap-2 w-full px-3 py-2 rounded-md text-sm \
...
pub const TRIGGER_DISABLED: &str = "inline-flex items-center justify-between gap-2 w-full px-3 py-2 rounded-md text-sm \
...
pub const CALENDAR_ICON: &str = "size-4 shrink-0 text-[var(--color-label-secondary)]";

/// The calendar popup panel.
pub const PANEL: &str = "absolute z-50 mt-1 rounded-lg p-4 w-[300px] \
     bg-[var(--color-card)] \

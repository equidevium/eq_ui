...
pub const BACKDROP: &str = "fixed inset-0 z-50 flex items-center justify-center \
...
pub const PANEL: &str = "relative w-full mx-4 rounded-xl border border-[var(--color-card-border)] \
...
pub const HEADER: &str = "flex items-center justify-between px-5 py-4 \
...
pub const BODY: &str = "px-5 py-4 overflow-y-auto text-sm text-[var(--color-label-primary)]";

pub const FOOTER: &str = "flex items-center justify-end gap-2 px-5 py-4 \

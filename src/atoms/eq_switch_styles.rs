...
pub const WRAPPER: &str = "inline-flex items-center gap-2.5 cursor-pointer select-none";
...
pub const TRACK: &str = "inline-flex items-center shrink-0 rounded-full \
     bg-[var(--color-label-secondary)]/30 p-0.5";

/// Track (on).
pub const TRACK_ON: &str = "inline-flex items-center shrink-0 rounded-full \
     bg-[var(--color-accent-primary)] p-0.5";

/// The sliding thumb circle. Offset controlled via inline style.
pub const THUMB: &str = "rounded-full bg-white shadow-sm \

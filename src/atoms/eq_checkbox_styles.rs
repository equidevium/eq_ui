...
pub const WRAPPER: &str = "inline-flex items-center gap-2 cursor-pointer select-none";
...
pub const ICON: &str = "size-5 shrink-0 text-[var(--color-label-secondary)] \
     transition-colors";

/// Icon when checked or indeterminate.
pub const ICON_ACTIVE: &str = "size-5 shrink-0 text-[var(--color-accent-primary)] \
     transition-colors";

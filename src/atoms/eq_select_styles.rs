...
/// The listbox panel.
pub const LISTBOX: &str = "absolute z-50 mt-1 w-full max-h-60 rounded-md py-1 \
     bg-[var(--color-card)] \
...
pub const SEARCH: &str = "w-full px-3 py-2 text-sm \
...
/// A single option.
pub const OPTION: &str = "w-full px-3 py-2 text-left text-sm cursor-pointer \
...
/// Selected option.
pub const OPTION_SELECTED: &str = "bg-[var(--color-accent-primary)]/10 font-medium";

/// Disabled option.
pub const OPTION_DISABLED: &str = "opacity-40 cursor-not-allowed pointer-events-none";

/// Check mark shown on selected option.
pub const CHECK: &str = "size-4 shrink-0 text-[var(--color-accent-primary)]";

/// Empty state when search yields no results.
pub const EMPTY: &str = "px-3 py-4 text-center text-sm text-[var(--color-label-secondary)]";

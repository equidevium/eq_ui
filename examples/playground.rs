    ...
    vec![
        TreeNode::new_with_children(
            ...
            vec![
                ...
                TreeNode::new("button", "EqButton"),
                TreeNode::new("progress", "EqProgress"),
            ],
        ),
        TreeNode::new_with_children(
            "molecules",
...
fn DemoEqProgress() -> Element {
    ...
    let styles = "TRACK: \"progress\"\n\
        ...
        SOLID: \"progress-fill-solid\"".to_string();
...
fn DemoEqButton() -> Element {
    ...
    let styles = "BASE: \"btn\"\n\
        PRIMARY: \"btn-primary\"  — gradient bg, @property color morph on hover\n\
        GHOST: \"btn-ghost\"  — transparent bg, subtle hover fill\n\
        OUTLINE: \"btn-outline\"  — bordered, gradient hover reveal\n\
        CARD: \"btn-card\"  — card-styled with glow shadow and lift\n\
        DANGER: \"btn-danger\"  — red bg, brightness shift on hover\n\
        NO_GRADIENT: \"btn-no-gradient\"  — flat solid color, no gradient\n\
        NO_TRANSITION: \"btn-no-transition\"  — disables gradient animation\n\
        SM: \"btn-sm\"  — 0.375rem 0.75rem, text-sm\n\
        MD: \"btn-md\"  — 0.5rem 1rem, text-sm\n\
        LG: \"btn-lg\"  — 0.625rem 1.5rem, text-base".to_string();
    ...
    rsx! {
        DemoSection { title: "EqButton",
                ...
                if click_count() > 0 {
                    {
                        ...
                        rsx! {
                            EqText { variant: TextVariant::Caption,
            ...
            div { class: "space-y-4",
                ...
                div { class: "space-y-3",
                    for (v_name , v) in variant_names.iter() {
                        div { class: "space-y-1",
                            EqText { variant: TextVariant::Caption, class: "font-medium", "{v_name}" }
            ...
            StyleInfo { file: "eq_button_styles.rs", styles }
            CodeBlock { code }
        }
    }
}
